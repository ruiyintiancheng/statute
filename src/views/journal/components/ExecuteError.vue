 ...
 * @Last Modified time: 2020-11-20 14:01:12
 * @Description:  执行错误
 */
<template>
    ...
    <div class="">
      ...
      <div>
        <el-table :data="data"
          ...
          <el-table-column prop="stateErrUri"
                           label="错误执行地址"
                           align="center"
                           min-width="200">
          </el-table-column>
          <el-table-column prop="stateErrNum"
                           label="错误次数"
                           align="center"
                           min-width="200">
          </el-table-column>
          <el-table-column prop="stateErrType"
                           label="错误代码"
                           align="center"
                           min-width="200">
          </el-table-column>
          <el-table-column prop="stateErrUpdTime"
                           label="最后错误时间"
                           align="center"
                           min-width="200">
                    <template slot-scope="scope">
                        {{scope.row.stateErrUpdTime || scope.row.stateErrAddTime}}
                    </template>
          </el-table-column>
        </el-table>
...
const url = '/taskStateErr/selects'
export default {
  data() {
    return {
      pageNo: 1,
