 ...
 * @Last Modified by: lk
 * @Last Modified time: 2020-03-12 11:05:23
 * @Description:  执行成功
 */
<template>
    ...
    <div class="">
      ...
      <div>
        <el-table :data="data"
          ...
          <el-table-column prop="stateSusUri"
                           label="已执行地址"
                           align="center"
                           min-width="200">
          </el-table-column>
          <el-table-column prop="stateSusFilePath"
                           label="文件地址"
                           align="center"
                           min-width="200">
          </el-table-column>
          <el-table-column prop="stateSusAddTime"
                           label="创建时间"
                           align="center"
                           min-width="200">
          </el-table-column>
...
const url = '/taskStateSus/selects'
export default {
  data() {
    return {
      pageNo: 1,
